NOTE: This lib has been reasonably heavily modified and shouldn't be expected to be replaceable drop-in with future versions of the original lib, if they exist in the future.
